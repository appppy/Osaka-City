 ...
 *  @author APPPPY
 */
public class FIRE_DISASTER_PREVENTION_SPEAKER implements IOsakaProperty {
    /**
     * @serial 色
     */
     ...
     * コンストラクタ
     */
    public FIRE_DISASTER_PREVENTION_SPEAKER() {
        mColorList.add(0xff795548);
        mColorList.add(0xffefebe9);
    }
    ...
    public String getKey() {
        return KEY_FIRE_DISASTER_PREVENTION_SPEAKER;
    }
    ...
    public String getUrl() {
        return "http://www.city.osaka.lg.jp/contents/wdu090/opendata/mapnavoskdat_csv/mapnavoskdat_bousaisp.csv";
    }
    ...
    @Override
    public int getId() {
        return R.string.fire_disaster_prevention_speaker;
    }
